...
func (r *Raft) makeConnection(port int, msg interface{}) net.Conn {
...
func (r *Raft) send(serverId int, msg interface{}) {
	...
	//fmt.Println("In send", r.myId(), "sending to:", serverId)
...
func (r *Raft) candidate() int {
	...
	for {
		...
		r.f_specific[r.Myconfig.Id].Vote = true //set self vote true
...
func (r *Raft) leader() int {
	...
	for {
		...
		case ClientAppendReq:
			...
			//fmt.Println("Sent AE_Req", r.myId())
